...
module.exports = (theme) => ({
    DEFAULT: {
        css: [
            {
                color: theme('colors.yellow.50', defaultTheme.colors.yellow[50]),
                maxWidth: '65ch',
                '[class~="lead"]': {
                    color: theme('colors.yellow.50', defaultTheme.colors.yellow[50]),
                },
                a: {
                    ...
                    textDecorationColor: theme('colors.yellow.DEFAULT'),
                    fontWeight: '500',
                },
                strong: {
                ...
                '.content-list > ul > li::before': {
                    content: '""',
                    position: 'absolute',
                    backgroundColor: theme('colors.yellow.DEFAULT', defaultTheme.colors.yellow['DEFAULT']),
                    borderRadius: '50%',
                },
                hr: {
                ...
                blockquote: {
                    ...
                    borderLeftColor: theme('colors.yellow.DEFAULT'),
                    quotes: '"\\201C""\\201D""\\2018""\\2019"',
                    backgroundColor: theme('colors.gray.800', defaultTheme.colors.gray[200]),
                },
                ...
                ':not(pre) > code': {
                    backgroundColor: theme('colors.gray.800'),
                    padding: defaultTheme.spacing['0.5'] + ' ' + defaultTheme.spacing['1.5'],
                },
                'code::before': {
                    content: '',
                },
